...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="contents">
                <div>
                    <h3 class="dashHeader">학과정보 수정</h3>
                </div>
                <div class="dashboard-style">
                    <form id="editForm" method="post" action="departmentmodifypro.jsp">
                        <div id="container" class="table-responsive" style="border: 0px; overflow: auto">
                            <table class="table" style="table-layout:fixed; margin-bottom: 0px;" width=100%>
                               <tr>
                               		<td>학과코드</td><td><input type="text" name="dcode" value="<%=request.getParameter("dcode")%>" readonly/></td>
                               </tr>
                                <tr>
                              
                                    <td>학과명</td><td><input type=text name="dname" value="<%=request.getParameter("dname")%>"></td>
                                </tr>
