...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="contents">
                <div>
                    <h3 class="dashHeader">교수정보 수정</h3>
                </div>
                <div class="dashboard-style">
                    <form id="editForm" method="post" action="professormodifypro.jsp">
                        <div id="container" class="table-responsive" style="border: 0px; overflow: auto">
                            <table class="table" style="table-layout:fixed; margin-bottom: 0px;" width=100%>
                               <tr>
                               		<td>교수번호</td><td><input type="text" name="pronum" value="<%=request.getParameter("pronum")%>" readonly /></td>
                               </tr>
                                <tr>
                              
                                    <td>교수</td><td><input type=text name="proname" value="<%=request.getParameter("proname")%>"></td>
                                </tr>
                                 <tr>
                                    <td>학과명</td><td><select id="class" name="dname"></select></td>
                                </tr>
                                <tr>
                                    <td>연구실</td><td><input type=text name="lab" value="<%=request.getParameter("lab")%>"></td>
                                </tr>
                                <tr>
                                    <td>연락처</td><td><input type=text name="tel" value="<%=request.getParameter("tel")%>"></td>
                                </tr>
                            </table>
                        </div>
    ...
    <%
										...
										String comp=(String)request.getParameter("departmentname");
         							%>
<script>
        							//학과리스트
